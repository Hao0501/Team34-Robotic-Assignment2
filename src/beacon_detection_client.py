...
class BeaconDetectionClient(object):
    ...
    def __init__(self):
        ...
        rospy.init_node("beacon_detection_client")

        self.rate = rospy.Rate(2)

        self.goal = SearchGoal()

        self.client = actionlib.SimpleActionClient("/beacon_detection_server", 
                    SearchAction)
    ...
    def main(self):
        ...
        if prempt:
            ...
            print("RESULT: beacon {:.3f} m away at a location of {:.3f} degrees".format(result.closest_object_distance, result.closest_object_angle))

if __name__ == '__main__':
    ac_object = BeaconDetectionClient()
    try:
        ac_object.main()
